...
2. Implementar y verificar (mediante simulación) un flip-flop D maestro-esclavo.
3. Implementar y verificar (mediante simulación) una máquina de estado finito que implemente un controlador de semáforo de un cruce de calles.
