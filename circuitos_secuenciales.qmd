...
3. Implementar y simular en [*Digital*](https://github.com/hneemann/Digital) una máquina de estado finito que implemente un controlador de semáforo de un cruce de calles. [^1]

[^1]: La especificación del controlador de semáforo se proporcionará en clase.
