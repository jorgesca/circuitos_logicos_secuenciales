...
1. Investigar en la bibliografía lo siguiente:
    ...
    7. Máquinas de estado finito.
        7.1 Concepto.
        7.2 Estructura general y tipos.
        7.3 Formas de representación.
        7.4 Asignación de estados.
        7.5 Análisis y síntesis.

2. Implementar y simular en el simulador [*Digital* (https://github.com/hneemann/Digital)](https://github.com/hneemann/Digital), un flip-flop D maestro-esclavo.
3. Implementar y simular en [*Digital*](https://github.com/hneemann/Digital) una máquina de estado finito que implemente un controlador de semáforo de un cruce de calles.
...
- *En todo el informe*
    - Cita todo material bibliográfico utilizado para la elaboración del informe de acuerdos a la norma APA (Sánchez, 2020). Esto incluye tablas, figuras, etc. incluidas directamente o material consultado para la elaboración del informe. 
- *Resúmen*
...
Las simulaciones deben funcionar de manera correcta. El flip-flop D debe ser construido con compuertas y tener la topología maestro-esclavo, esta simulación representa 3 puntos. La máquina de estado de control de semáforos debe funcionar correctamente y estar de acuerdo al desarrollo presentado en el informe, representa los 7 puntos restantes.
